...
def commit_batch_audit(
    ...
    *,
    ...
    provider_lane: str = "correction",
    model_source: str = "general_model_fallback",
    degraded: bool = False,
    fallback: bool = True,
    retry: bool = False,
) -> dict[str, Any]:
    ...
    audit = {
        ...
        "provider_lane": _safe_audit_value(provider_lane, fallback="correction"),
        "model_source": _safe_audit_value(model_source, fallback="unknown_model_source"),
