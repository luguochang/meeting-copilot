...
def _realistic_meeting_simulation_pack_profile(profile_id: str) -> dict[str, Any]:
    if profile_id == "long_shadow":
        return {
            "scenario_id": "task_127_long_architecture_release_review",
            "meeting_shape": {
                "speaker_count": 5,
    ...
    return {
        "scenario_id": "task_126_release_incident_review",
        "meeting_shape": {
            "speaker_count": 4,
...
def _desktop_asr_worker_handoff_dry_run_readiness() -> dict[str, Any]:
    phases = [
        ...
        },
        {
            ...
            "item_count": 1,
            "safe_to_proceed": False,
            "source_status_field": "next_task_id",
            "source_status_value": "task-106",
        },
        {
...
def _desktop_mic_adapter_contract_readiness() -> dict[str, Any]:
    ...
    return {
        "task_id": "task-106",
        "source_task_id": contract_report.get("task_id", "task-105"),
