...
def test_build_approach_cards_applies_confidence_and_evidence_gates():
    ...
    cards, usage = llm_service.build_approach_cards("转写文本", _config(), client=FakeClient(resp))
...
def test_build_approach_cards_caps_at_three():
    ...
    cards, _ = llm_service.build_approach_cards("t", _config(), client=FakeClient(resp))
